...
double Exponentiation(int n, int m) // Метод возведения в степень числа
{
    int level = m;
    if (level < 0) // Проверка на отрицательный показатель степени и приведение его к натуральному виду
    {
